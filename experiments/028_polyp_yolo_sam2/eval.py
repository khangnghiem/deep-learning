...
def main():
    ...
    for img_path in tqdm(test_images, desc="Evaluating YOLO -> SAM2"):
        ...
        # 1. YOLO predicts boxes
        yolo_results = yolo_model(img, conf=config['evaluation']['conf_threshold'], verbose=False)[0]
